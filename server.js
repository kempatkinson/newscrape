...
axios.get("https://www.basketball-reference.com/leagues/NBA_2020_per_game.html").then(function (response) {
...
app.post("/player/:id", function(req, res) {
  ...
  db.Note.create(req.body)
    .then(function(dbNote) {
      ...
      return db.Player.findOneAndUpdate({ _id: req.params.id }, { note: dbNote._id }, { new: true });
    })
    .then(function(dbPlayer) {
